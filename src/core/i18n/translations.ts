...
const en = {
  ...
  // ─── Footer ───
  "footer.tagline":
    "Pixetide — 100% browser-powered. Your images never leave your device.",
  ...
  "home.heroSubtitle":
    "Edit, compress, and convert your images without uploading anything. All processing runs locally in your browser to guarantee your privacy. A suite built with care to save you hours of work.",
  "home.watermarkText": "PRIVACY",
  "home.heroMicrocopyLine1": "100% local image tools",
  "home.heroMicrocopyLine2": "no registration - no account - no file uploads",
  "home.heroTitleLine1": "Image editing tools, free and",
  "home.heroTitleAccent": "private.",
  "home.editorialHeroSubtitle": "Compress, convert, remove backgrounds and add watermarks without uploading your images. Everything is processed locally in your browser.",
  "home.heroPrimaryCta": "Use Free Tools",
  "home.heroGithubCta": "View on GitHub",
  "home.badgeText": "WebAssembly Local Processing",
  "home.featuredTitle": "Featured Tools",
  "home.featured.convert": "Convert Images (JPG, PNG, WebP, AVIF)",
  "home.featured.removeBg": "Remove Image Background for Free",
  "home.featured.watermark": "Add Watermark to Images",
  "home.featured.compress": "Compress Images Without Losing Quality",
  "home.moreTools": "More Tools . . .",
  "home.allToolsTitle": "All Image Tools",

  // ─── Home Cards ───
  "card.crop.title": "Crop Images for Social Media",
  "card.crop.desc":
    "Resize your photos to the perfect aspect ratio for Instagram, Facebook, or Pinterest. Crop images online easily without losing quality.",
  "card.compress.title": "Compress Images Without Quality Loss",
  "card.compress.desc":
    "Reduce the size of your JPG, PNG, or WebP images by up to 80% so your website loads faster. Smart, secure, and instant compression.",
  "card.convert.title": "Convert Image Format",
  "card.convert.desc":
    "Convert images to WebP, AVIF, JPG, or PNG in bulk. The ideal format to optimize your SEO and improve user experience.",
  "card.rotateFlip.title": "Rotate & Flip Images",
  "card.rotateFlip.desc":
    "Rotate your photos or apply a mirror effect easily. Ideal for straightening crooked images or creating symmetric compositions — 100% private.",
  "card.watermark.title": "Add Watermark to Photos",
  "card.watermark.desc":
    "Protect your photographs by adding your logo or text as a watermark. Everything is processed locally in your browser for maximum privacy.",
  "card.upscale.title": "Enhance Image Quality",
  "card.upscale.desc":
    "Increase the resolution of blurry or old photos. Enlarge images without pixelation using advanced upscaling technology — right in your browser. (Coming Soon)",
  "card.removeBg.title": "Remove Background",
  "card.removeBg.desc":
    "Magically remove the background from any image using AI directly in your browser. Compare before and after instantly.",
  "card.colorPalette.title": "Extract Color Palette",
  "card.colorPalette.desc":
    "Extract the dominant colors from any image and get their HEX codes. The ideal tool for web designers and creatives. Instant and local processing.",
  "card.photoEditor.title": "Online Photo Editor",
  "card.photoEditor.desc":
    "Adjust brightness, contrast, and apply professional filters for free. Fast and private photo editing from the comfort of your screen. (Coming Soon)",
  "card.base64.title": "Base64 Converter",
  "card.base64.desc":
    "Encode your images to Base64 for embedding in HTML or CSS, or decode Base64 back to an image. Bidirectional, instant, and 100% private.",
  ...
  "shared.privacyColors":
    "Colors are extracted locally. Total privacy guaranteed.",
  ...
  "shared.errorExport":
    "Could not process the image. Make sure the file is still accessible.",

  // ─── Tool Page Headers ───
  "tool.crop.h1": "Crop & Resize Images.",
  "tool.crop.subtitle":
    "Resize your photos to the ideal format for Instagram, TikTok, or the web. All processing is local and private in your browser.",
  "tool.compress.h1": "Compress Images Without Losing Quality.",
  "tool.compress.subtitle":
    "Drastically reduce the file size of your JPG, PNG, or WebP photos. Boost your website speed and SEO with secure local compression.",
  "tool.convert.h1": "Image Format Converter.",
  "tool.convert.subtitle":
    "Convert your photos to WebP, AVIF, JPG, or PNG in bulk. Everything is processed in your browser to protect your original files.",
  "tool.rotate.h1": "Rotate & Flip Images.",
  "tool.rotate.subtitle":
    "Rotate and apply mirror effects to your photos easily and quickly — 100% private from your browser.",
  "tool.watermark.h1": "Add Watermark to Photos.",
  "tool.watermark.subtitle":
    "Protect your photos by adding your logo or signature as a watermark. Everything is processed locally in your browser for maximum privacy.",
  "tool.palette.h1": "Extract Color Palette.",
  "tool.palette.subtitle":
    "Get the dominant, vibrant, and muted colors from any image. Ideal for web designers and creatives. Instant and 100% private processing.",
  "tool.base64.h1": "Base64 Converter.",
  "tool.base64.subtitle":
    "Encode your images to Base64 for embedding in HTML or CSS, or decode a Base64 string back to a downloadable image. 100% local and private.",
  "tool.removeBg.h1": "Remove Background with AI.",
  "tool.removeBg.subtitle":
    "Magically remove the background from any image using Artificial Intelligence directly in your browser. Private, fast, and professional.",

  // ─── Optimizer Module ───
  "opt.compression": "Compression",
  "opt.compressionDesc":
    "Lower quality means smaller file size. The Normal level works best for most use cases.",
  "opt.options": "Options",
  ...
  "cp.networkError":
    "Connection error: Could not download the color engines. Retry or reload the page.",
  ...
  "b64.decodeError":
    'The text does not appear to be a valid Base64 image. Make sure it starts with "data:image/..." or is a pure Base64 string.',
  "b64.decodeImageError":
    "Could not decode the image. Verify that the Base64 code is complete and valid.",
  ...
  "bgrm.downloadingDesc":
    "Preparing the smart engine locally for the first time.",
  "bgrm.removingDesc":
    "The AI is processing the edges of your image in your browser.",
  ...
  "conv.white": "White",
  "conv.black": "Black",
  "conv.performanceWarning":
    "files detected. Local processing may take a few seconds.",
  ...
  "conv.mode": "Conversion Mode",
  "conv.batch": "Batch (All images)",
  "conv.individual": "Individual (Set per image)",
  "conv.targetFormat": "Target Format",
  "conv.bgColor": "Background Color",
  "conv.bgColorDesc": "Choose a background color to replace transparency (required for JPG format).",
  "conv.bgColorWarning": "Warning: JPG format does not support transparency. Transparent areas will be replaced with the chosen background color.",
  "conv.convert": "Convert",
  "conv.download": "Download",
  "conv.downloadZip": "Download (.zip)",
  "conv.imageList": "Image List",
  "conv.statusPending": "Pending",
  "conv.statusSuccess": "Success",
  "conv.statusError": "Error",
  "conv.actions": "Actions",
  "conv.noImages": "No images uploaded yet",
  "conv.uploadNew": "Upload New",
  "conv.downloadAll": "Download All",
  "conv.downloadAllZip": "Download All (.zip)",
  "conv.successMessage": "Successfully converted all images.",
  "conv.errorMessage": "Failed to convert some images.",

  // ─── 404 ───
  "notFound.title": "Oops! 404",
  "notFound.message":
    "This photo got lost in development. The page you're looking for doesn't exist or has been moved.",
  ...
  "pdf.dropzoneHint": "PNG, JPG, WEBP, GIF, SVG, HEIC, HEIF, or BMP. Max 20MB per file.",
...
const es: Record<TranslationKey, string> = {
  ...
  // ─── Footer ───
  "footer.tagline":
    "Pixetide — Rendimiento 100% en tu navegador. Tus imágenes nunca salen de tu dispositivo.",
  ...
  "home.watermarkText": "PRIVACIDAD",
  "home.heroMicrocopyLine1": "Herramientas de imágen 100% locales",
  "home.heroMicrocopyLine2": "sin registro - sin cuenta - sin subir archivos",
  "home.heroTitleLine1": "Herramientas de imagen, gratis y",
  "home.heroTitleAccent": "privada.",
  "home.editorialHeroSubtitle": "Comprime, convierte, elimina fondos y añade marcas de agua sin subir tus imágenes. Todo se procesa localmente en tu navegador.",
  "home.heroPrimaryCta": "Usar herramientas gratis",
  "home.heroGithubCta": "Ver en GitHub",
  "home.badgeText": "Procesamiento Local WebAssembly",
  "home.featuredTitle": "Herramientas Destacadas",
  "home.featured.convert": "Convertir Imágenes (JPG, PNG, WebP, AVIF)",
  "home.featured.removeBg": "Eliminar Fondo de Imagen gratis",
  "home.featured.watermark": "Añadir Marca de Agua a imágenes",
  "home.featured.compress": "Comprimir Imágenes Sin Perder Calidad",
  "home.moreTools": "Más Herramientas . . .",
  "home.allToolsTitle": "Todas las Herramientas",

  // ─── Home Cards ───
  "card.crop.title": "Recortar Fotos para Redes",
  "card.crop.desc":
    "Adapta tus imágenes al tamaño perfecto para Instagram, Facebook o Pinterest. Recorta fotos online fácilmente y sin perder calidad.",
  "card.compress.title": "Comprimir Imágenes sin Perder Calidad",
  "card.compress.desc":
    "Reduce el peso de tus fotos JPG, PNG o WebP hasta en un 80% para que tu web cargue más rápido. Compresión inteligente, segura y al instante.",
  "card.convert.title": "Convertir Formato de Imagen",
  "card.convert.desc":
    "Convierte fotos a WebP, AVIF, JPG o PNG de forma masiva. El formato ideal para optimizar tu SEO y mejorar la experiencia de tus usuarios.",
  "card.rotateFlip.title": "Girar y Voltear Imágenes",
  "card.rotateFlip.desc":
    "Rota tus fotos o aplícales un efecto espejo fácilmente. Ideal para enderezar imágenes torcidas o crear composiciones simétricas de forma 100% privada.",
  "card.watermark.title": "Poner Marca de Agua a Fotos",
  "card.watermark.desc":
    "Protege tus fotografías añadiendo tu logo o texto como marca de agua. Todo se procesa localmente en tu navegador para garantizar tu privacidad.",
  "card.upscale.title": "Mejorar Calidad de Imagen",
  "card.upscale.desc":
    "Aumenta la resolución de fotos borrosas o antiguas. Agranda imágenes sin pixelarlas usando tecnología de escalado avanzada desde tu navegador. (Próximamente)",
  "card.removeBg.title": "Quitar Fondo",
  "card.removeBg.desc":
    "Elimina el fondo de cualquier imagen mágicamente usando IA directamente en tu navegador. Compara el antes y después al instante.",
  "card.colorPalette.title": "Extraer Paleta de Colores",
  "card.colorPalette.desc":
    "Saca los colores predominantes de cualquier imagen y obtén sus códigos HEX. La herramienta ideal para diseñadores web y creativos. Procesamiento instantáneo y local.",
  "card.photoEditor.title": "Editor de Fotos Online",
  "card.photoEditor.desc":
    "Ajusta el brillo, contraste y aplica filtros profesionales gratis. Edición fotográfica rápida y privada desde la comodidad de tu pantalla. (Próximamente)",
  "card.base64.title": "Convertidor Base64",
  "card.base64.desc":
    "Codifica tus imágenes a Base64 para incrustarlas en HTML o CSS, o decodifica un código Base64 a imagen. Bidireccional, instantáneo y 100% privado.",
  ...
  "shared.privacyHint":
    "Tus imágenes se procesan localmente. Nunca se envían a ningún servidor.",
  "shared.privacyShort": "Máxima calidad. 100% privado.",
  "shared.privacyLocal": "Procesamiento local: tus datos están seguros.",
  "shared.privacyColors":
    "Tus colores se extraen localmente. Privacidad total garantizada.",
  "shared.privacyBg":
    "100% procesado localmente. Privacidad total garantizada.",
  "shared.errorProcessing": "Hubo un error al procesar la imagen.",
  "shared.errorValidation": "Error al validar el archivo.",
  "shared.errorExport":
    "No se pudo procesar la imagen. Asegúrate de que el archivo aún sea accesible.",

  // ─── Tool Page Headers ───
  "tool.crop.h1": "Recorte y Redimensión de Imágenes.",
  "tool.crop.subtitle":
    "Ajusta tus fotos a los formatos ideales para Instagram, TikTok o Web. Todo el procesamiento es local y privado en tu navegador.",
  "tool.compress.h1": "Comprimir Imágenes sin Perder Calidad.",
  "tool.compress.subtitle":
    "Reduce drásticamente el peso de tus fotos JPG, PNG o WebP. Mejora la velocidad de tu web y tu SEO con nuestra compresión local segura.",
  "tool.convert.h1": "Convertidor de Formatos de Imagen.",
  "tool.convert.subtitle":
    "Cambia el formato de tus fotos a WebP, AVIF, JPG o PNG masivamente. Todo se procesa en tu navegador para proteger tus archivos originales.",
  "tool.rotate.h1": "Girar y Voltear Imágenes.",
  "tool.rotate.subtitle":
    "Rota y aplica efectos de espejo a tus fotos de manera fácil y rápida, 100% privado desde tu navegador.",
  "tool.watermark.h1": "Poner Marca de Agua a Fotos.",
  "tool.watermark.subtitle":
    "Protege tus fotos añadiendo tu logo o firma como marca de agua. Todo se procesa localmente en tu navegador para garantizar tu privacidad.",
  "tool.palette.h1": "Extraer Paleta de Colores.",
  "tool.palette.subtitle":
    "Obtén los colores predominantes, vibrantes y tenues de cualquier imagen. Ideal para diseñadores web y creativos. Procesamiento instantáneo y 100% privado.",
  "tool.base64.h1": "Convertidor Base64.",
  "tool.base64.subtitle":
    "Codifica tus imágenes a Base64 para incrustarlas en HTML o CSS, o decodifica un código Base64 a imagen descargable. Todo el procesamiento es 100% local y privado.",
  "tool.removeBg.h1": "Quitar Fondo con IA.",
  "tool.removeBg.subtitle":
    "Elimina el fondo de cualquier imagen mágicamente usando Inteligencia Artificial directamente en tu navegador. Privado, rápido y profesional.",

  // ─── Optimizer Module ───
  "opt.compression": "Compresión",
  "opt.compressionDesc":
    "A menor calidad, menor peso. El nivel Normal es ideal para la mayoría de casos.",
  ...
  "cp.networkError":
    "Error de conexión: No se pudieron descargar los motores de color. Reintenta o recarga la página.",
  ...
  "b64.decodeError":
    'El texto no parece ser una imagen en Base64 válida. Asegúrate de que comience con "data:image/..." o sea una cadena Base64 pura.',
  "b64.decodeImageError":
    "No se pudo decodificar la imagen. Verifica que el código Base64 esté completo y sea válido.",
  ...
  "conv.globalDesc":
    "Cambia el formato de salida para todos los archivos a la vez.",
  ...
  "conv.black": "Negro",
  "conv.performanceWarning":
    "archivos detectados. El proceso local puede tomar unos segundos.",
  "conv.privacyHint":
    "Procesamiento local: tus fotos nunca salen de este navegador.",
  "conv.noValidImages": "No se encontraron imágenes válidas.",
  "conv.maxFilesError":
    "Solo puedes subir un máximo de {max} imágenes a la vez.",
  "conv.invalidFile": "El archivo {name} no es válido: {error}",
  "conv.mode": "Modo de Conversión",
  "conv.batch": "Por lote (Todas las imágenes)",
  "conv.individual": "Individual (Ajustar por imagen)",
  "conv.targetFormat": "Formato de Destino",
  "conv.bgColor": "Color de Fondo",
  "conv.bgColorDesc": "Elige un color de fondo para reemplazar la transparencia (necesario para el formato JPG).",
  "conv.bgColorWarning": "Advertencia: El formato JPG no soporta transparencias. Las zonas transparentes se rellenarán con el color de fondo seleccionado.",
  "conv.convert": "Convertir",
  "conv.download": "Descargar",
  "conv.downloadZip": "Descargar (.zip)",
  "conv.imageList": "Lista de Imágenes",
  "conv.statusPending": "Pendiente",
  "conv.statusSuccess": "Listo",
  "conv.statusError": "Error",
  "conv.actions": "Acciones",
  "conv.noImages": "Aún no has subido imágenes",
  "conv.uploadNew": "Subir Nueva",
  "conv.downloadAll": "Descargar todo",
  "conv.downloadAllZip": "Descargar todo (.zip)",
  "conv.successMessage": "Se han convertido todas las imágenes correctamente.",
  "conv.errorMessage": "Hubo un error al convertir algunas imágenes.",
  ...
  "pdf.dropzoneHint": "PNG, JPG, WEBP, GIF, SVG, HEIC, HEIF o BMP. Máximo 20MB por archivo.",
