...
import { OptimizationPreset, OPTIMIZATION_PRESETS } from './optimizer';
import { rawOptimizeImage, formatBytes, OptimizationResult } from './imageOptimizer';
      ...
      <div className="opt-main-layout">
        ...
        <div className="opt-workspace">
          ...
          >
            ...
            {isProcessing && (
              <Loader variant="overlay" message={t('opt.optimizing')} />
            )}
          </div>
