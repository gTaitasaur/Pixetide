...
var getOrt = async (useWebGPU) => {
  ...
  if (useWebGPU) {
    ort = (await import("./ort.webgpu.bundle.min-SJJAABVL.js")).default;
  } else {
    ort = (await import("./ort.bundle.min-C3VKI23N.js")).default;
  }
  return ort;
};
...
async function removeBackground(image, configuration) {
  ...
  (_a = config.progress) == null ? void 0 : _a.call(config, "compute:inference", 1, 4);
  const [alphamask2, imageTensor] = await runInference(
    inputImageTensor,
    config,
    session
  );
  (_b = config.progress) == null ? void 0 : _b.call(config, "compute:mask", 2, 4);
  ...
  (_c = config.progress) == null ? void 0 : _c.call(config, "compute:encode", 3, 4);
  const outImage = await imageEncode(
    outImageTensor,
    config.output.quality,
    config.output.format
  );
  (_d = config.progress) == null ? void 0 : _d.call(config, "compute:encode", 4, 4);
  return outImage;
}
